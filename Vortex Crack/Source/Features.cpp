...
void WriteVehicle(std::string name, Vehicle veh) {
	std::string iniPath = ".\\VortexFolder\\ini files\\" + name + ".ini";
...
void WritePreset(std::string name, float id, float x, float y, float z, float rotx, float roty, float rotz, Hash model) {
	std::string iniPath = ".\\VortexFolder\\ini files\\" + name + ".ini"; //change path
...
void Features::AntiReport(bool toggle) {
	Hooking::defuseEvent(REPORT_MYSELF_EVENT, toggle);
	Hooking::defuseEvent(REPORT_CASH_SPAWN_EVENT, toggle);
}

bool Features::antiEvery = false;
void Features::AntiEverything(bool toggle) {
	Hooking::defuseEvent(SCRIPT_ARRAY_DATA_VERIFY_EVENT, toggle);
	Hooking::defuseEvent(REQUEST_CONTROL_EVENT, toggle);
	Hooking::defuseEvent(GIVE_CONTROL_EVENT, toggle);
	Hooking::defuseEvent(WEAPON_DAMAGE_EVENT, toggle);
	Hooking::defuseEvent(REQUEST_PICKUP_EVENT, toggle);
	Hooking::defuseEvent(REQUEST_MAP_PICKUP_EVENT, toggle);
	Hooking::defuseEvent(GAME_CLOCK_EVENT, toggle);
	Hooking::defuseEvent(GAME_WEATHER_EVENT, toggle);
	Hooking::defuseEvent(RESPAWN_PLAYER_PED_EVENT, toggle);
	Hooking::defuseEvent(GIVE_WEAPON_EVENT, toggle);
	Hooking::defuseEvent(REMOVE_WEAPON_EVENT, toggle);
	Hooking::defuseEvent(REMOVE_ALL_WEAPONS_EVENT, toggle);
	Hooking::defuseEvent(REMOVE_ALL_WEAPONS_EVENT, toggle);
	Hooking::defuseEvent(REMOVE_ALL_WEAPONS_EVENT, toggle);
	Hooking::defuseEvent(VEHICLE_COMPONENT_CONTROL_EVENT, toggle);
	Hooking::defuseEvent(FIRE_EVENT, toggle);
	Hooking::defuseEvent(EXPLOSION_EVENT, toggle);
	Hooking::defuseEvent(START_PROJECTILE_EVENT, toggle);
	Hooking::defuseEvent(ALTER_WANTED_LEVEL_EVENT, toggle);
	Hooking::defuseEvent(CHANGE_RADIO_STATION_EVENT, toggle);
	Hooking::defuseEvent(RAGDOLL_REQUEST_EVENT, toggle);
	Hooking::defuseEvent(PLAYER_TAUNT_EVENT, toggle);
	Hooking::defuseEvent(PLAYER_CARD_STAT_EVENT, toggle);
	Hooking::defuseEvent(DOOR_BREAK_EVENT, toggle);
	Hooking::defuseEvent(SCRIPTED_GAME_EVENT, toggle);
	Hooking::defuseEvent(REMOTE_SCRIPT_INFO_EVENT, toggle);
	Hooking::defuseEvent(REMOTE_SCRIPT_LEAVE_EVENT, toggle);
	Hooking::defuseEvent(MARK_AS_NO_LONGER_NEEDED_EVENT, toggle);
	Hooking::defuseEvent(CONVERT_TO_SCRIPT_ENTITY_EVENT, toggle);
	Hooking::defuseEvent(SCRIPT_WORLD_STATE_EVENT, toggle);
	Hooking::defuseEvent(INCIDENT_ENTITY_EVENT, toggle);
	Hooking::defuseEvent(CLEAR_AREA_EVENT, toggle);
	Hooking::defuseEvent(CLEAR_RECTANGLE_AREA_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_REQUEST_SYNCED_SCENE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_START_SYNCED_SCENE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_UPDATE_SYNCED_SCENE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_STOP_SYNCED_SCENE_EVENT, toggle);
	Hooking::defuseEvent(GIVE_PED_SCRIPTED_TASK_EVENT, toggle);
	Hooking::defuseEvent(GIVE_PED_SEQUENCE_TASK_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_CLEAR_PED_TASKS_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_START_PED_ARREST_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_START_PED_UNCUFF_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_SOUND_CAR_HORN_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_ENTITY_AREA_STATUS_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_GARAGE_OCCUPIED_STATUS_EVENT, toggle);
	Hooking::defuseEvent(PED_CONVERSATION_LINE_EVENT, toggle);
	Hooking::defuseEvent(SCRIPT_ENTITY_STATE_CHANGE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_PLAY_SOUND_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_STOP_SOUND_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_PLAY_AIRDEFENSE_FIRE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_BANK_REQUEST_EVENT, toggle);
	Hooking::defuseEvent(REQUEST_DOOR_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_TRAIN_REQUEST_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_TRAIN_REPORT_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_INCREMENT_STAT_EVENT, toggle);
	Hooking::defuseEvent(MODIFY_VEHICLE_LOCK_WORD_STATE_DATA, toggle);
	Hooking::defuseEvent(REQUEST_PHONE_EXPLOSION_EVENT, toggle);
	Hooking::defuseEvent(REQUEST_DETACHMENT_EVENT, toggle);
	Hooking::defuseEvent(KICK_VOTES_EVENT, toggle);
	Hooking::defuseEvent(GIVE_PICKUP_REWARDS_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_CRC_HASH_CHECK_EVENT, toggle);
	Hooking::defuseEvent(BLOW_UP_VEHICLE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_SPECIAL_FIRE_EQUIPPED_WEAPON, toggle);
	Hooking::defuseEvent(NETWORK_RESPONDED_TO_THREAT_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_SHOUT_TARGET_POSITION, toggle);
	Hooking::defuseEvent(PICKUP_DESTROYED_EVENT, toggle);
	Hooking::defuseEvent(UPDATE_PLAYER_SCARS_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_CHECK_EXE_SIZE_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_PTFX_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_PED_SEEN_DEAD_PED_EVENT, toggle);
	Hooking::defuseEvent(REMOVE_STICKY_BOMB_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_CHECK_CODE_CRCS_EVENT, toggle);
	Hooking::defuseEvent(INFORM_SILENCED_GUNSHOT_EVENT, toggle);
	Hooking::defuseEvent(PED_PLAY_PAIN_EVENT, toggle);
	Hooking::defuseEvent(CACHE_PLAYER_HEAD_BLEND_DATA_EVENT, toggle);
	Hooking::defuseEvent(REMOVE_PED_FROM_PEDGROUP_EVENT, toggle);
	Hooking::defuseEvent(REPORT_MYSELF_EVENT, toggle);
	Hooking::defuseEvent(REPORT_CASH_SPAWN_EVENT, toggle);
	Hooking::defuseEvent(ACTIVATE_VEHICLE_SPECIAL_ABILITY_EVENT, toggle);
	Hooking::defuseEvent(NETWORK_CHECK_CATALOG_CRC, toggle);
}

bool Features::antiAttachment = false;
void Features::AntiAttachment(bool toggle) {
	Hooking::defuseEvent(REQUEST_DETACHMENT_EVENT, toggle);
...
void Features::AntiPtfx(bool toggle) {
	Hooking::defuseEvent(NETWORK_PTFX_EVENT, toggle);
}
...
void Features::eventShield() {
	...
	for (int i = 0; i < 124; i++)
	{
		...
		if (eventID == 360381720) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to CEO ban you.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
				globalHandle(1382674).At(558).As<int>() = 558;
				unsigned int Bit = (1 << var0[1]);
				SCRIPT::eventur(1, var0, 10, Bit);
			}
		}
		if (eventID == -1190833098) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to CEO kick you.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == 769347061) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to kick you.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == 999090520) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to kick you to singleplayer.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == -1571039706) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to send you to a mission.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == 1000837481) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to teleport you.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == 4119492672) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to soundspam you.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == -1920290846) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to send an error to you.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == -181444979) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to show you a banner.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
		...
		if (eventID == -2105858993) {
			char* playername = PLAYER::GET_PLAYER_NAME(var0[1]);
			notifyMap("%s tried to kick you from the club.", playername);
			if (playername != PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_PED_ID())) {
				unsigned int Bit = (1 << var0[1]);
				SCRIPT::eventur(1, var0, 10, Bit);
			}
...
bool Features::remoteBanProtectionBool = false;
void Features::remoteBanProtection(bool toggle) {
	globalHandle(1382674).At(609).As<int>() = 609;
}

bool Features::antiFreeze = false;
void Features::AntiFreeze(bool toggle) {
	Hooking::defuseEvent(RAGDOLL_REQUEST_EVENT, toggle);
	Hooking::defuseEvent(INCIDENT_ENTITY_EVENT, toggle);
	Hooking::defuseEvent(CLEAR_AREA_EVENT, toggle);
	Hooking::defuseEvent(CLEAR_RECTANGLE_AREA_EVENT, toggle);
...
void Features::UpdateLoop() //bool loop
{
	...
	if (Features::penisdunigger)
	{
		if ((timeGetTime() - Features::TimePD3) > Features::stealthdelay)
		{
			...
			notifyMap("~b~Bank~w~ Transaction Active");
		}
	}
	...
	if (Features::geiletitte)
	{
		...
		if ((timeGetTime() - Features::TimePD3) > Features::stealthdelay)
		{
			...
			notifyMap("~b~Wallet~w~ Transaction Active");
		}
	}
	...
	NeverWanted2 ? neverWanted2(true) : NULL;
	...
	featureWalk ? featureWalkk(true) : NULL;
	...
	remoteBanProtectionBool ? remoteBanProtection(true) : NULL;
	...
	srainbowcar ? sRainbowCar(true) : NULL;

	rainbowneon ? Rainbowneon(true) : NULL;

	srainbowneon ? sRainbowneon(true) : NULL;

	srainbowtire ? sRainbowtire(true) : NULL;

	dorbool ? dOffRadar(true) : NULL;

	vehjumps ? VehJumps(true) : NULL;
...
void Features::paranormal(bool toggle)
{
	if (GetAsyncKeyState(VK_NUMPAD9))
	{
		...
		UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("CHAR_SOCIAL_CLUB", "CHAR_SOCIAL_CLUB", 1, 8, "~b~Vortex", "~w~YEET", 1, "UnlockAll", 9, 0);
	...
	if (STREAMING::IS_MODEL_VALID(model))
	{
		...
		if (Features::spawnmaxed)
		{
			...
			for (int i = 0; i < 50; i++)
			{
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(vehicle, "Vortex");
...
void Features::Superman(bool toggle)
{
	...
	notifyBottom("~b~press Space, W, A, D, S...");
...
void Features::neverWanted2(bool toggle) {
	if (neverWanted2)
	{
		Memory::set_value<int32_t>({ (2 * 4 * 2) / 2, 4 * 1000 + 280, 500 * 4 - 70 + 70 + 72 },5 - 1 + 1 - 0 + 1 - 1);
	}
}
...
char* Features::setPlayerName(int player, char* tag) {
	std::ostringstream playerOption;
...
bool Features::fixfire2 = false;
void Features::firefix2(bool toggle)
{
	if (fixfire2)
	{
		if (IsPedShooting(PLAYER::PLAYER_PED_ID())) {
			...
			if (Tmp[0] != 0 || Tmp[2] != 0 || Tmp[4] != 0)
			{
				FIRE::ADD_EXPLOSION(Tmp[0], Tmp[2], Tmp[4], 30, 0, true, false, 0);
			}
		}
	}
}
...
bool Features::featureWalk = false;
void Features::featureWalkk(bool toggle)
{
	Ped playerPed = PLAYER::PLAYER_PED_ID();
...
bool Features::dorbool = false;
void Features::dOffRadar(bool toggle)
{
...
void Features::antiAFK(bool toggle) {
	...
	notifyMap("~w~Anti AFK Is Active");
...
void Features::DepositToBank()
{
	...
	UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2("CHAR_YOUTUBE", "CHAR_YOUTUBE", 1, 8, "~b~Vortex", "~w~Recovery", 1, "", 9, 0);
	UI::_DRAW_NOTIFICATION(FALSE, FALSE);
}
...
void Features::vf(char* guuk) {
	...
	if (STREAMING::HAS_MODEL_LOADED(hash) && STREAMING::HAS_MODEL_LOADED(hash2) && STREAMING::HAS_MODEL_LOADED(hash3) && STREAMING::HAS_MODEL_LOADED(hash4) && STREAMING::HAS_MODEL_LOADED(hash5))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Vehicle) && ENTITY::DOES_ENTITY_EXIST(Object) && ENTITY::DOES_ENTITY_EXIST(Broom) && ENTITY::DOES_ENTITY_EXIST(Cone) && ENTITY::DOES_ENTITY_EXIST(Tool))
		{
			...
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(Object, "Vortex");
	...
	if (NameESP)
	{
		...
		for (int i = 0; i < 32; i++)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(playerHandle))
			{
				...
				std::string nameSetupRed = playerName;
				...
				UI::SET_TEXT_COLOUR(espr, espg, espb, 255);
	...
	if (toggle)
	{
		...
		for (int i = 0; i < 32; i++)
		{
			...
			if (excludeMe > 0 && excludeMe != PLAYER::PLAYER_PED_ID())
			{
				...
				SET_ENTITY_INVINCIBLE(zentorno, 0);
...
void Features::LoadPlayerInfo(char* playerName, Player p) {
	...
	std::ostringstream Money, RP, Rank, Kills, Deaths, KD, Earnings, Money1, Moneybank, Golf, EXP, Races, Raceslost, Miss, Death, Deathlost;

	Vector3 __coords = ENTITY::GET_ENTITY_COORDS(ped, 0);
	char buf[0x80]; snprintf(buf, sizeof(buf), "X: ~b~%f", __coords.x);
	char buf1[0x80]; snprintf(buf1, sizeof(buf1), "~s~Y: ~b~%f", __coords.y);
	char buf2[0x80]; snprintf(buf2, sizeof(buf2), "~s~Z: ~b~%f", __coords.z);

	std::string money2 = std::to_string(tempMoney);
	...
	*/
	...
	Menu::AddSmallInfo(buf, 16);
	Menu::AddSmallInfo(buf1, 17);
	Menu::AddSmallInfo(buf2, 18);
	Menu::AddSmallInfo((char*)Earnings.str().c_str(), 19);
	Menu::AddSmallInfo((char*)Money1.str().c_str(), 20);
	Menu::AddSmallInfo((char*)Death.str().c_str(), 21);
	Menu::AddSmallInfo((char*)Deathlost.str().c_str(), 22);
	Menu::AddSmallInfo((char*)Races.str().c_str(), 23);
	Menu::AddSmallInfo((char*)Raceslost.str().c_str(), 24);
...
char* Features::jointext = "Joining GTA Online with Vortex VIP";
...
void Features::antiTSE(bool toggle) {
	globalHandle(1377446).At(33).As<int>() = 33; //Sound
...
bool Features::srainbowcar = false;
void Features::sRainbowCar(bool toggle)
{
	if (srainbowcar)
	{
		...
		NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0));
		int VehID = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		VEHICLE::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(VehID, Color[0], Color[1], Color[2]);
		VEHICLE::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(VehID, Color[0], Color[1], Color[2]);
	}
}
bool Features::rainbowneon = false;
void Features::Rainbowneon(bool toggle)
{
	if ((timeGetTime() - TimePD5) > 150) // Time between drops
	{
		NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0));
		int VehID = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
bool Features::srainbowneon = false;
void Features::sRainbowneon(bool toggle)
{
	if (srainbowneon)
	{
		static int Color[] = { 255, 0, 0 };
		...
		NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0));
		int VehID = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		VEHICLE::_SET_VEHICLE_NEON_LIGHTS_COLOUR(VehID, Color[0], Color[1], Color[2]);
	}
}
bool Features::srainbowtire = false;
void Features::sRainbowtire(bool toggle)
{
	if (srainbowtire)
	{
		static int Color[] = { 255, 0, 0 };
		...
		NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0));
		int VehID = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(VehID, Color[0], Color[1], Color[2]);
	}
}

bool Features::vehjumps = false;
void Features::VehJumps(bool toggle)
{
...
void Features::timespam() {
	if (!tstimer) {
		Features::set_session_time(12, 0, 0);
		tstimer = true;
	}
	else {
		Features::set_session_time(23, 0, 0);
		tstimer = false;
	}
}