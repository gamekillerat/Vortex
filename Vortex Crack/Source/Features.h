...
namespace Features {
	...
	void VehJumps(bool toggle);

	extern bool antiReport;
	void AntiReport(bool toggle);

	extern bool remoteBanProtectionBool;
	void remoteBanProtection(bool toggle);

	extern int cargobob_strength;

	extern bool antiEvery;
	void AntiEverything(bool toggle);
...
#
	...
	extern float get_stat(Hash stat_hash);
	...
	extern bool fixfire2;
	void firefix2(bool toggle);
	...
	extern bool antitse;
	void antiTSE(bool toggle);

	extern bool eventShieldBool;

	extern char* jointext;
	...
	extern bool srainbowcar;
	void sRainbowCar(bool toggle);
	
	extern bool rainbowneon;
	void Rainbowneon(bool toggle);
	
	extern bool srainbowneon;
	void sRainbowneon(bool toggle);
	
	extern bool srainbowtire;
	void sRainbowtire(bool toggle);
